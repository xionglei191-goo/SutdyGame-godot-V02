...
const SECOND_BATCH_ASSETS: Array[Dictionary] = [
	{"asset_id": "story_prop.home.clock_chair_corner", "story_prop_id": "story_prop_marker_home_clock_chair_corner", "anchor_id": "anchor_c_clock"},
	{"asset_id": "story_prop.home.sunny_towel_dog_corner", "story_prop_id": "story_prop_marker_home_sunny_towel_dog_corner", "anchor_id": "anchor_d_dog"},
	{"asset_id": "story_prop.home.watch_wall_charm", "story_prop_id": "story_prop_marker_home_watch_wall_charm", "anchor_id": "anchor_w_watch"},
	{"asset_id": "story_prop.school.gate_bell_sign", "story_prop_id": "story_prop_marker_school_gate_bell_sign", "anchor_id": "anchor_g_gate"},
	{"asset_id": "story_prop.walk.kite_leaf_path", "story_prop_id": "story_prop_marker_walk_kite_leaf_path", "anchor_id": "anchor_k_kite"},
	{"asset_id": "story_prop.shop.orange_bowl_window", "story_prop_id": "story_prop_marker_shop_orange_bowl_window", "anchor_id": "anchor_o_orange"},
	{"asset_id": "story_prop.plaza.sun_flower_patch", "story_prop_id": "story_prop_marker_sun_flower_patch", "anchor_id": "anchor_s_sun"},
]
...
func _check_second_batch_assets_resolve() -> void:
	...
	for entry in SECOND_BATCH_ASSETS:
		...
		_expect(path.begins_with("res://assets/art/story_props/"), "V02.37 STORYBATCH-003 asset should live under story_props: %s" % asset_id)
		...
		_expect(str(record.get("status", "")) == "production", "V02.37 STORYBATCH-003 asset should remain production before approval: %s" % asset_id)
		_expect(str(record.get("viewport_evidence", "")) == "pending_1280_runtime_proof", "V02.37 STORYBATCH-003 asset proof should remain pending: %s" % asset_id)
